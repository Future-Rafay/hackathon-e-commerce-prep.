...
const Services = () => {
    const services = [
        {
            ...
            icon: (
                <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_35803_335)">
        ...
        },
        {
            ...
            icon: (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_35803_352)">
    ...
    return (
        <div className="flex justify-center items-center gap-[88px] w-[943px] h-[161px] mb-[140px] mx-auto flex-wrap">
            {services.map((service, index) => (
                <div
                    key={index}
                    className="flex flex-col items-center gap-[24px] w-auto h-[161px]"
                >
