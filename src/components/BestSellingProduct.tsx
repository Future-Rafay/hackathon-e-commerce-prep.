        ...
        <div>
            ...
            <div className="relative w-[1170px] h-[500px] mx-auto mb-[70px]">
                ...
                <div className="absolute w-[600px] h-[420px] left-[526px] top-[37px] flex items-center justify-center">
                    {/* <div className="w-[568px] h-[330px] bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: 'url("/images/image.png")' }}></div>
                     */}
                    <img src="/images/blackSpeaker.png" alt="image" />
                </div>
            </div>
        </div >
    )
